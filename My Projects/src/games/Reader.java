 ...
 * package jb; (My own package, will include input and graphics; basically things for game programming)
 */
/**
...
public class Reader {
	...
	private void error(String w) {
		System.out.println("Reader says- " + w);
	}
